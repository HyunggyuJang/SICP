;;; eccomplr.scm (also called: eceval-compiler.scm)

;;;;This is the explicit-control evaluator from eceval.scm
;;;;modified to support compiled code.
...
;; To use it, load "load-ec.scm", which loads this file and the
...
(define eceval-operations
  (list
   ...
   ;;operations in compiledcode-support.scm
