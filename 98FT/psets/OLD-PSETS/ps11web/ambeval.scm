;;;; AMB Evaluator from Section 4.3 of SICP

;;; Matches code in ch4.scm.

;;;  You can initialize and start the AMB evaluator
;;;  (setting up the global environment and starting the driver loop)
;;;  by evaluating the following two lines in Scheme.
...
(define (driver-loop)
  ...
  (internal-loop
   (lambda ()
     ...
     (driver-loop))))

;;; AMBRUN is used to execute individual AMBScheme expressions 
