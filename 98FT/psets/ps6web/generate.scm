...
;;;; This file, part of problem set 6, just contains things like the
...
(define web
  '((http://www-swiss.ai.mit.edu/6.001
     ...
     (18:30:02 1998 6.001 6001-WEBMASTER@AI.MIT.EDU 8 
    ...
    (http://www-swiss.ai.mit.edu/6.001/SchemeImplementations
      ...
      *the-goal*)
     (11:09 1997 1998 3.1 34-501 4.0 6.001 6001-WEBMASTER@AI.MIT.EDU 
    ...
    (http://www-swiss.ai.mit.edu/6.001/psets
     ()
     (0 1 15 1997 1998 2 20 23:32:29 28 3 4 5 6.001
	6001-WEBMASTER@AI.MIT.EDU 98 A ABOUT ALL ALSO AND ARE AS 
    ...
    (http://www-swiss.ai.mit.edu/6.001/getting-help.html
     (http://www-swiss.ai.mit.edu/6.001
      http://www-swiss.ai.mit.edu/6.001/SchemeImplementations)
     (09:38:18 1 10 1998 2 23 24 339-0052 4 5 6 6.001 6001-HELP@MIT.EDU
	       6001-WEBMASTER@AI.MIT.EDU 8 947-2394 98 A ABLE ABOUT 
    ...
    (http://www-swiss.ai.mit.edu/6.001/lab-use.html
     ()
     (1 1997 1998 2 24 34-501 4:33 6.001 6001-WEBMASTER@AI.MIT.EDU 7 8 A
...
(define *all-words*
  '#(0 09:38:18 1 10 11:09 15 18:30:02 1997 1998 2 20 23 23:32:29
       24 28 3 3.1 339-0052 34-501 4 4.0 4:33 5 6 6.001
       6001-HELP@MIT.EDU 6001-WEBMASTER@AI.MIT.EDU 7 7.5A 8 947-2394
...
(define (make-random-web size guarantee-path-to-all-nodes?)
  ...
  (let ((n-total-names (vector-length *all-words*)))
    (write-line "Choosing node names...")
    (let ((node-names
	   (map (lambda (n)
		  (string->symbol
		   (string-append
