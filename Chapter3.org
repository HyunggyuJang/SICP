...
I didn't tested it but it would work. Since I'm going to implement above task
using more opaque way as lectured in [[youtube:bWJlEevfp1E?list=PL7BcsI5ueSNFPCEisbaoQ0kXIDX9rR5FF][Abstract Data Type]].
